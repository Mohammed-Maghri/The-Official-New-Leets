...
export const TeamGrid: React.FC<TeamGridProps> = ({
  ...
  if (filteredTeams.length === 0) {
    return (
      ...
      >
        <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-8 md:p-12 max-w-lg mx-auto">
          <div className="text-6xl md:text-8xl mb-4 opacity-60">🔍</div>
