...
const SkeletonCard: React.FC = () => (
  <div className="flex flex-col w-full h-auto border-4 theme-border-strong bg-[#ece9d8] py-6 px-3 gap-6 relative" style={{ fontFamily: "var(--font-ui)", boxShadow: "none" }}>
    ...
    <div className="w-full flex justify-center items-center pt-4 pb-2 min-h-[160px]">
      <div className="w-[120px] h-[120px] rounded-full border-4 theme-border overflow-hidden skeleton-shimmer flex-shrink-0" style={{ boxShadow: "none" }} />
    </div>
    {/* Middle section - matches RankComponent gap-3 */}
    <div className="w-full flex flex-col items-center gap-3">
      {/* Username - px-4 py-2 */}
      <div className="w-full px-4">
        <div className="h-8 border-2 theme-border overflow-hidden skeleton-shimmer" style={{ boxShadow: "none" }} />
      </div>
      {/* Level - text-[18px] */}
      <div className="w-14 h-6 border-2 theme-border overflow-hidden skeleton-shimmer" style={{ boxShadow: "none" }} />
      {/* Name - min-h-[36px] */}
      <div className="w-full px-2">
        <div className="h-9 min-h-[36px] border-2 theme-border overflow-hidden skeleton-shimmer mx-auto" style={{ boxShadow: "none", maxWidth: "140px" }} />
      </div>
      {/* Status - px-3 py-1.5 min-w-[100px] */}
      <div className="w-24 h-7 border-2 theme-border overflow-hidden skeleton-shimmer" style={{ boxShadow: "none" }} />
    </div>
  </div>
);

const SkeletonListCard: React.FC = () => (
  <div className="flex flex-row w-full min-h-[110px] border-4 theme-border-strong bg-[#ece9d8] p-2 sm:p-4 gap-2 relative" style={{ fontFamily: "var(--font-ui)", boxShadow: "none" }}>
    <div className="absolute top-0 left-0 w-4 h-4 border-l-2 border-t-2 theme-border" />
    <div className="absolute top-0 right-0 w-4 h-4 border-r-2 border-t-2 theme-border" />
    <div className="absolute bottom-0 left-0 w-4 h-4 border-l-2 border-b-2 theme-border" />
    <div className="absolute bottom-0 right-0 w-4 h-4 border-r-2 border-b-2 theme-border" />
    {/* Image block */}
    <div className="w-[80px] sm:w-[110px] h-full flex-shrink-0 border-2 theme-border overflow-hidden skeleton-shimmer" style={{ boxShadow: "none", minHeight: "90px" }} />
    <div className="flex-1 flex flex-col gap-2 min-w-0">
      {/* Top row */}
      <div className="flex gap-2">
        <div className="h-8 flex-1 border-2 theme-border overflow-hidden skeleton-shimmer" style={{ boxShadow: "none" }} />
      </div>
      {/* Name */}
      <div className="h-4 w-[75%] border-2 theme-border overflow-hidden skeleton-shimmer" style={{ boxShadow: "none" }} />
      {/* Level bar */}
      <div className="h-3 w-full border-2 theme-border overflow-hidden skeleton-shimmer" style={{ boxShadow: "none" }} />
    </div>
  </div>
);
...
const Progress = () => {
  ...
  return (
    <div className="xp-ranking-layout">
      <aside className="xp-ranking-sidebar">
        <section className="xp-filter-panel">
          <h2>Filters</h2>
          <div className="xp-filter-body">
        ...
        <div className="flex flex-row items-center gap-2">
          <div className="flex-1 relative min-w-0 order-1">
            <input
              ...
              className="w-full px-3 sm:px-4 py-2 pl-9 sm:pl-10 bg-[#dce8f8] border border-[#a0a6b0] rounded-md theme-text focus:outline-none focus:border-[#a0a6b0] focus:ring-1 focus:ring-white/10 text-[10px] sm:text-[11px] font-medium placeholder:text-[#3e3d35] transition-colors"
            />
            <div className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-[#3e3d35] pointer-events-none">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-[#3e3d35] hover:text-[#151515] transition-colors"
              >
                ✕
              </button>
            )}
          </div>
          <div className="flex rounded-lg overflow-hidden border border-[#a0a6b0] sm:shrink-0 order-2">
            <button onClick={() => setViewMode("list")} className={`px-3 sm:px-4 py-2 text-[10px] font-medium transition-colors ${viewMode === "list" ? "bg-[#dce8f8] text-[#151515] border-r border-[#a0a6b0]" : "bg-[#dce8f8] text-[#3e3d35] hover:text-[#151515] hover:bg-[#dce8f8] border-r border-[#a0a6b0]"}`} title="List View">
              <BsLayoutSidebar className="w-4 h-4 sm:mr-1 inline" />
              <span className="hidden sm:inline">List</span>
            </button>
            <button onClick={() => setViewMode("grid")} className={`px-3 sm:px-4 py-2 text-[10px] font-medium transition-colors ${viewMode === "grid" ? "bg-[#dce8f8] text-[#151515] border-r border-[#a0a6b0]" : "bg-[#dce8f8] text-[#3e3d35] hover:text-[#151515] hover:bg-[#dce8f8] border-r border-[#a0a6b0]"}`} title="Grid View">
      ...
      <div className={`xp-ranking-results items-center justify-start flex-col p-3 sm:p-4 w-full gap-2 flex overflow-y-auto overflow-x-hidden flex-1 min-h-0 pb-20 sm:pb-8 ${
        ...
        {isSearching || isFetchingData ? (
          ...
          <div className="w-full flex flex-col gap-6">
            ...
            {viewMode === "grid" ? (
              <div className="w-full flex flex-col gap-6">
                ...
                <div className="w-full mb-2 md:mb-3 px-2 md:px-4">
                  ...
                  <div className="hidden md:flex relative justify-center items-start gap-5 max-w-[900px] mx-auto min-h-[300px]">
                    <div className="flex flex-col items-center flex-1 max-w-[280px]" style={{ paddingTop: "60px" }}>
                      <div className="w-full"><SkeletonCard /></div>
                    </div>
                    <div className="flex flex-col items-center flex-1 max-w-[290px]" style={{ paddingTop: "0px" }}>
                      <div className="w-full"><SkeletonCard /></div>
                    </div>
                    <div className="flex flex-col items-center flex-1 max-w-[280px]" style={{ paddingTop: "120px" }}>
                      <div className="w-full"><SkeletonCard /></div>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col items-center justify-center flex-1 w-full h-full min-h-[400px]">
            <div className="relative mb-6">
              <div className="w-20 h-20 md:w-24 md:h-24 border-2 theme-border bg-[#ece9d8] flex items-center justify-center" style={{ boxShadow: "none" }}>
                <div className="text-4xl md:text-5xl">🔍</div>
              </div>
              <div className="absolute -top-1 -right-1 w-6 h-6 bg-[#d9e5f5] rounded-full flex items-center justify-center">
                <span className="text-[#151515] text-xs font-bold">!</span>
              </div>
            </div>
              ...
              >
                {isLoadingMore ? (
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 border-2 border-[#a0a6b0] border-t-white rounded-full animate-spin"></div>
                    <span>Loading...</span>
                  </div>
                ) : (
          ...
          <>
            ...
            {userData[0] != null && (
              <div className="w-[100%] min-h-[80px] flex items-center justify-center mt-4 pb-8 sm:pb-12">
                <button
                  className={`px-8 py-3 border-2 theme-border bg-[#ece9d8] theme-text font-bold text-sm uppercase tracking-wider
                  transition-all duration-200 active:translate-y-0.5
