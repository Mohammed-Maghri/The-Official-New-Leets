...
export const TeamGrid: React.FC<TeamGridProps> = ({
  ...
  if (filteredTeams.length === 0) {
    return (
      ...
      >
        <div className="bg-[#ece9d8]  border border-[#616161]/30 rounded-2xl p-8 md:p-12 max-w-lg mx-auto">
          <div className="text-6xl md:text-8xl mb-4 opacity-60 text-[#616161]">✕</div>
          <h3 className="text-xl md:text-2xl font-bold text-[#151515] font-Tektur mb-4">
            No Teams Found
          </h3>
