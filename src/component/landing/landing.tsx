  ...
  return (
    <>
      <div className="w-[300px] h-[440px] bg-gray-900/30 border-solid border-[1px] rounded-md border-gray-600/40 backdrop-blur-lg z-20 flex flex-col items-center justify-center p-8 space-y-6 shadow-xl">
        ...
        <button
          onClick={() => window.open("https://github.com/Mohammed-Maghri", "_blank")}
          className="cursor-pointer w-full bg-gradient-to-r border-solid border-[1px] border-gray-500/40 from-gray-900/20
             ...
             duration-300 hover:scale-105 hover:from-gray-800/30 hover:to-gray-700/30 hover:shadow-gray-500/20"
        >
          <div className="flex items-center justify-center space-x-2">
