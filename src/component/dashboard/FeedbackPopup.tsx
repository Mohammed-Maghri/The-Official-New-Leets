...
const FeedbackPopup: React.FC<FeedbackPopupProps> = ({ onClose, username }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80  animate-fadeIn p-0 sm:p-4" style={{ fontFamily: "var(--font-ui)" }}>
      <div role="dialog" aria-modal="true" aria-label="Share your ideas" className="xp-dialog relative w-full h-full sm:max-w-4xl sm:max-h-[90vh] bg-[#ece9d8] border-2 sm:border-4 theme-border-strong overflow-hidden"
        style={{ boxShadow: "none" }}
      >
        <XPDialogTitle title="Share your ideas" onClose={onClose} />

        {/* Content */}
        <div className="relative min-h-0 flex-1 flex flex-col p-4 sm:p-8 md:p-12 overflow-y-auto">
          {!submitted && !showConfirmation && !showError ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-4 sm:gap-6">
                ...
                {errors.feedback && !feedback && (
                  <div className="border-2 border-[#a0a6b0] bg-[#d9e5f5] p-3" style={{ boxShadow: "none" }}>
                    <p className="text-[#3e3d35] text-xs sm:text-sm text-center font-bold uppercase tracking-wider">
                      {errors.feedback}
                    </p>
                  </div>
                )}
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  />
                  {errors.feedback && feedback && (
                    <p className="text-[#3e3d35] text-xs mt-1 font-bold uppercase">{errors.feedback}</p>
                  )}
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <textarea
                    ...
                    className={`min-h-[100px] sm:min-h-[120px] p-3 sm:p-4 bg-[var(--theme-bg-card)] border-2 text-[var(--theme-text)] placeholder-[var(--theme-text-muted)] text-sm resize-none focus:outline-none transition-all ${
                      errors.dislikes ? "border-[#a0a6b0]" : "theme-border focus:border-[var(--theme-primary)]"
                    }`}
                    style={{ boxShadow: "none" }}
                  />
                  {errors.dislikes && (
                    <p className="text-[#3e3d35] text-xs mt-1 font-bold uppercase">{errors.dislikes}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  <label htmlFor="improvements" className="flex theme-text-muted text-sm sm:text-base font-bold items-center gap-2 uppercase tracking-wider">
                    <span className="text-[#3e3d35]">💡</span> What&apos;s Missing?
                  </label>
                  <textarea
                    value={improvements}
                    onChange={(e) => {
                    ...
                    className={`min-h-[100px] sm:min-h-[120px] p-3 sm:p-4 bg-[var(--theme-bg-card)] border-2 text-[var(--theme-text)] placeholder-[var(--theme-text-muted)] text-sm resize-none focus:outline-none transition-all ${
                      errors.improvements ? "border-[#a0a6b0]" : "theme-border focus:border-[var(--theme-primary)]"
                    }`}
                    style={{ boxShadow: "none" }}
                  />
                  {errors.improvements && (
                    <p className="text-[#3e3d35] text-xs mt-1 font-bold uppercase">{errors.improvements}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className={`flex items-center gap-2 sm:gap-3 ${
                    errors.rating ? "border-2 border-[#a0a6b0] p-2" : ""
                  }`}
                    style={errors.rating ? { boxShadow: "none" } : {}}
                  >
                    {[1, 2, 3, 4, 5].map((star) => (
                      <button
                        key={star}
                      ...
                      >
                        {(hoverRating || rating) >= star ? (
                          <IoStar className="w-8 h-8 sm:w-10 sm:h-10 text-[#3e3d35] " />
                        ) : (
                          <IoStarOutline className="w-8 h-8 sm:w-10 sm:h-10 text-[#3e3d35] hover:text-[#3e3d35]" />
                        )}
                      </button>
                    ))}
                    {rating > 0 && (
                  ...
                  {errors.rating && (
                    <p className="text-[#3e3d35] text-xs mt-2 font-bold uppercase">{errors.rating}</p>
                  )}
                ...
                <div className="border-t-2 theme-border pt-4 sm:pt-6">
                  {/* Badge Showcase */}
                  <div className="bg-[var(--theme-bg-card)] border-2 theme-border p-3 sm:p-4 mb-4 sm:mb-6" style={{ boxShadow: "none" }}>
                    ...
                    <div className="flex flex-col gap-2 sm:gap-3 items-center">
                      {/* Genius Badge */}
                      <div className="px-3 py-1.5 border-2 border-[#a0a6b0] flex flex-row items-center gap-1 bg-[#d9e5f5]" style={{ boxShadow: "none" }}>
                        <BsLightbulb className="text-[#3e3d35] text-[12px]" />
                        <span className="text-[#3e3d35] text-[8px] font-bold tracking-widest uppercase">GENIUS</span>
                      </div>
                      {/* Helpful Badge */}
                      <div className="px-3 py-1.5 border-2 border-[#a0a6b0] flex flex-row items-center gap-1 bg-[#d9e5f5]" style={{ boxShadow: "none" }}>
                        <FaHandsHelping className="text-[#3e3d35] text-[12px]" />
                        <span className="text-[#3e3d35] text-[8px] font-bold tracking-widest uppercase">HELPFUL</span>
                      </div>
                      {/* Innovative Badge */}
                      <div className="px-3 py-1.5 border-2 border-[#a0a6b0] flex flex-row items-center gap-1 bg-[#d9e5f5]" style={{ boxShadow: "none" }}>
                        <BsLightbulb className="text-[#3e3d35] text-[12px]" />
                        <span className="text-[#3e3d35] text-[8px] font-bold tracking-widest uppercase">INNOVATIVE</span>
                      </div>
                      {/* Thinker Badge */}
                      <div className="px-3 py-1.5 border-2 border-[#a0a6b0] flex flex-row items-center gap-1 bg-[#d9e5f5]" style={{ boxShadow: "none" }}>
                        <FaBrain className="text-[#3e3d35] text-[12px]" />
                        <span className="text-[#3e3d35] text-[8px] font-bold tracking-widest uppercase">THINKER</span>
                      </div>
                      {/* Contributor Badge */}
                      <div className="px-3 py-1.5 border-2 border-[#a0a6b0] flex flex-row items-center gap-1 bg-[#d9e5f5]" style={{ boxShadow: "none" }}>
                        <BsStars className="text-[#3e3d35] text-[12px]" />
                        <span className="text-[#3e3d35] text-[8px] font-bold tracking-widest uppercase">CONTRIBUTOR</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    ...
                    <label htmlFor="wantsToContribute" className="theme-text text-sm sm:text-base font-bold cursor-pointer flex items-center gap-2 uppercase tracking-wider">
                      <BsCodeSlash className="text-[#3e3d35] hidden sm:inline" />
                  ...
                  <p className="theme-text-muted text-xs ml-6 sm:ml-7 -mt-2 mb-3 flex items-center gap-1 opacity-80">
                    I&apos;ll contact through the website if you choose to collaborate <span className="text-[#3e3d35]">❤</span>
                  </p>
                </div>
            ...
            <div className="flex-1 flex flex-col overflow-y-auto">
              ...
              <div className="flex-1 space-y-4 overflow-y-auto mb-6">
                <div className="bg-[var(--theme-bg-card)] border-2 theme-border p-4" style={{ boxShadow: "none" }}>
                  ...
                  <div className="flex items-center gap-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <IoStar
                        key={star}
                        className={`w-5 h-5 ${
                          star <= rating ? "text-[#3e3d35]" : "text-[#3e3d35]"
                        }`}
                      />
                    ))}
                ...
                {feedback && (
                  <div className="bg-[var(--theme-bg-card)] border-2 border-[var(--theme-primary)]/50 p-4" style={{ boxShadow: "none" }}>
                ...
                {dislikes && (
                  <div className="bg-[var(--theme-bg-card)] border-2 border-[#a0a6b0] p-4" style={{ boxShadow: "none" }}>
                    <p className="text-[#3e3d35] text-xs mb-2 font-bold uppercase tracking-wider">Dislikes</p>
                ...
                {improvements && (
                  <div className="bg-[var(--theme-bg-card)] border-2 border-[#a0a6b0] p-4" style={{ boxShadow: "none" }}>
                    <p className="text-[#3e3d35] text-xs mb-2 font-bold uppercase tracking-wider">Improvements</p>
                ...
                {wantsToContribute && (
                  <div className="bg-[var(--theme-bg-card)] border-2 border-[#a0a6b0] p-4" style={{ boxShadow: "none" }}>
                    <p className="text-[#3e3d35] text-xs mb-2 font-bold uppercase tracking-wider">Wants to Contribute</p>
                    ...
                    <p className="theme-text text-sm">
                      ...
                      {contributionArea.map((area) => (
                        <span
                          key={area}
                          className="inline-block bg-[#d9e5f5] px-2 py-1 border border-[#a0a6b0] text-xs mr-2 capitalize font-bold"
                          style={{ boxShadow: "none" }}
                        >
                          {area}
                        </span>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
              <div className="mb-6">
                <div className="w-20 h-20 mx-auto mb-4 bg-[#d9e5f5] border-2 border-[#a0a6b0] flex items-center justify-center" style={{ boxShadow: "none" }}>
                  <IoClose className="w-10 h-10 text-[#3e3d35]" />
                </div>
              </div>
